...
class SimplifyIntensity(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        self.addParameter(QgsProcessingParameterFeatureSource(self.INPUT, "Input intensity layer"))
        ...
        self.addParameter(QgsProcessingParameterNumber(self.CHAIKEN_THRESHOLD, "Chaiken threshold", defaultValue=5))

        self.addParameter(QgsProcessingParameterNumber(self.REDUCE_THRESHOLD, "Reduce threshold", defaultValue=20))
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        result = processing.run(
            ...
            {"INPUT": result["OUTPUT"], "OUTPUT": "TEMPORARY_OUTPUT"},
            context=context,
            feedback=feedback,
            is_child_algorithm=True,
        )
