<qgis labelsEnabled="1" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms" version="3.40.3-Bratislava">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        ...
        <layer class="LinePatternFill" enabled="1" id="{f2cc1fde-9585-49b2-a0d1-d01801f5c05a}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="45"></Option>
            <Option name="clip_mode" type="QString" value="during_render"></Option>
            <Option name="color" type="QString" value="121,125,127,201,rgb:0.47450980392156861,0.49019607843137253,0.49803921568627452,0.78823529411764703"></Option>
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="@0@0" type="line">
            ...
            <layer class="SimpleLine" enabled="1" id="{5983318c-7328-48ba-9202-da32e09c7ae2}" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option name="line_color" type="QString" value="121,125,127,201,rgb:0.47450980392156861,0.49019607843137253,0.49803921568627452,0.78823529411764703"></Option>
        ...
        <layer class="SimpleFill" enabled="1" id="{9ed8d944-154f-4a38-92a3-00543fd61322}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
            <Option name="outline_color" type="QString" value="0,0,1,255,rgb:0,0,0.00392156862745098,1"></Option>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{e47ac32f-1a69-4193-883a-0e38f12fb5fb}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" blendMode="0" capitalization="0" fieldName="fonte_proc" fontFamily="Open Sans" fontItalic="0" fontKerning="1" fontLetterSpacing="0" fontSize="10" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="75" fontWordSpacing="0" forcedBold="0" forcedItalic="0" isExpression="0" legendString="Aa" multilineHeight="1" multilineHeightUnit="Percentage" namedStyle="Regular" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" tabStopDistance="80" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" tabStopDistanceUnit="Point" textColor="50,50,50,255,rgb:0.19607843137254902,0.19607843137254902,0.19607843137254902,1" textOpacity="1" textOrientation="horizontal" useSubstitutions="0">
        <families></families>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Diffuso" type="QString" value="1000"></Option>
              </Option>
              <Option type="Map">
                <Option name="Puntuale" type="QString" value="1001"></Option>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="commento" index="1" name="Osservazioni"></alias>
    <alias field="fonte_proc" index="2" name="Settore/i (fonte processo)"></alias>
    <alias field="scenario" index="3" name="Scenario"></alias>
  </aliases>
  <splitPolicies>
    <policy field="fid" policy="Duplicate"></policy>
    <policy field="commento" policy="Duplicate"></policy>
    <policy field="fonte_proc" policy="Duplicate"></policy>
    <policy field="scenario" policy="Duplicate"></policy>
  </splitPolicies>
  <duplicatePolicies>
    <policy field="fid" policy="Duplicate"></policy>
    <policy field="commento" policy="Duplicate"></policy>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="scenario"></default>
  </defaults>
  <constraints>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="&quot;fonte_proc&quot; != ''" field="fonte_proc"></constraint>
    <constraint desc="" exp="" field="scenario"></constraint>
  </constraintExpressions>
...
control = dialog.findChild(QWidget, "MyLineEdit")
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsed="0" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="1" groupBox="0" horizontalStretch="0" name="Attributi" showLabel="1" type="Tab" verticalStretch="0" visibilityExpression="" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField horizontalStretch="0" index="3" name="scenario" showLabel="1" verticalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" underline="0"></labelFont>
        </labelStyle>
  ...
  <editable>
    ...
    <field editable="1" name="scenario"></field>
  </editable>
  <labelOnTop>
    ...
    <field labelOnTop="0" name="scenario"></field>
  </labelOnTop>
  <reuseLastValue>
    ...
    <field name="scenario" reuseLastValue="0"></field>
  </reuseLastValue>
