<qgis labelsEnabled="1" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms" version="3.43.0-Master">
  <flags>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{e2908301-c6cc-40b6-86af-baf59f9dbd5e}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="outline_color" type="QString" value="31,120,250,255,rgb:0.12156862745098039,0.47058823529411764,0.98039215686274506,1"></Option>
            <Option name="outline_style" type="QString" value="solid"></Option>
            <Option name="outline_width" type="QString" value="0.46"></Option>
        ...
        <layer class="LinePatternFill" enabled="1" id="{fa66d403-2161-4206-abd4-5fa7fab3fc2c}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="distance" type="QString" value="2"></Option>
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="@0@1" type="line">
            ...
            <layer class="SimpleLine" enabled="1" id="{d5875839-1bb3-4e74-8b0b-85cca81b4357}" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option name="joinstyle" type="QString" value="bevel"></Option>
                <Option name="line_color" type="QString" value="31,120,180,255,rgb:0.12156862745098039,0.47058823529411764,0.70588235294117652,1"></Option>
                <Option name="line_style" type="QString" value="solid"></Option>
                <Option name="line_width" type="QString" value="0.15"></Option>
                <Option name="line_width_unit" type="QString" value="MM"></Option>
                <Option name="offset" type="QString" value="0"></Option>
                <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
                <Option name="offset_unit" type="QString" value="MM"></Option>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{6b17d3ff-6506-4e7d-b467-92ae3d6174ac}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="Description" type="invalid"></Option>
  ...
  <aliases>
    ...
    <alias field="commento" index="1" name="Nome"></alias>
    <alias field="proc_parz" index="2" name="Processo"></alias>
    <alias field="fonte_proc" index="3" name="Fonte processo"></alias>
  </aliases>
  <splitPolicies>
  ...
  <constraints>
    ...
    <constraint constraints="1" exp_strength="0" field="proc_parz" notnull_strength="1" unique_strength="0"></constraint>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsed="0" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="1" groupBox="0" horizontalStretch="0" name="Attributi" showLabel="1" type="Tab" verticalStretch="0" visibilityExpression="" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField horizontalStretch="0" index="2" name="proc_parz" showLabel="1" verticalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont bold="0" description="Noto Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" underline="0"></labelFont>
        </labelStyle>
