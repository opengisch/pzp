<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|Forms" version="3.43.0-Master">
  <renderer-v2 attr="classe_intensita" enableorderby="0" forceraster="0" referencescale="-1" symbollevels="1" type="categorizedSymbol">
    <categories>
      <category label="forte" render="true" symbol="0" type="string" uuid="0" value="1004"></category>
      <category label="medio" render="true" symbol="1" type="string" uuid="1" value="1003"></category>
      <category label="debole" render="true" symbol="2" type="string" uuid="2" value="1002"></category>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{94abfca8-01b7-4c99-a36b-f59232ed7149}" locked="0" pass="4">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="56,158,0,255,rgb:0.2196078431372549,0.61960784313725492,0,1"></Option>
            ...
            <Option name="outline_color" type="QString" value="164,158,152,255,rgb:0.64313725490196083,0.61960784313725492,0.59607843137254901,1"></Option>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="1" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{5937fe56-ad81-4488-8643-70811f0973e4}" locked="0" pass="3">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="161,230,23,255,rgb:0.63137254901960782,0.90196078431372551,0.09019607843137255,1"></Option>
            <Option name="joinstyle" type="QString" value="bevel"></Option>
            <Option name="offset" type="QString" value="0,0"></Option>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
            <Option name="outline_color" type="QString" value="130,130,130,255,rgb:0.50980392156862742,0.50980392156862742,0.50980392156862742,1"></Option>
            <Option name="outline_style" type="QString" value="solid"></Option>
            <Option name="outline_width" type="QString" value="0.26"></Option>
            <Option name="outline_width_unit" type="QString" value="MM"></Option>
            <Option name="style" type="QString" value="solid"></Option>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="2" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{3c88ea54-dc31-4d70-acef-298608f23e13}" locked="0" pass="2">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="209,255,115,255,rgb:0.81960784313725488,1,0.45098039215686275,1"></Option>
            <Option name="joinstyle" type="QString" value="bevel"></Option>
            <Option name="offset" type="QString" value="0,0"></Option>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{8ce54b97-d429-46bb-a47a-e3b9be66606f}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="237,76,44,255,rgb:0.92941176470588238,0.29803921568627451,0.17254901960784313,1"></Option>
            <Option name="joinstyle" type="QString" value="bevel"></Option>
            <Option name="offset" type="QString" value="0,0"></Option>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{7b8292bc-11ad-449a-9a1b-0bef97803fe7}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="markerSymbol" type="marker">
            ...
            <layer class="SimpleMarker" enabled="1" id="" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option name="color" type="QString" value="114,155,111,255,rgb:0.44705882352941179,0.60784313725490191,0.43529411764705883,1"></Option>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="crollo di roccia o frana" type="QString" value="3001"></Option>
              </Option>
            </Option>
          </Option>
        </config>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
      <labelFont bold="0" description="Ubuntu Sans,11,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" underline="0"></labelFont>
    </labelStyle>
    <attributeEditorContainer collapsed="0" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="1" groupBox="0" horizontalStretch="0" name="Attributi" showLabel="1" type="Tab" verticalStretch="0" visibilityExpression="" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField horizontalStretch="0" index="2" name="classe_intensita" showLabel="1" verticalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" underline="0"></labelFont>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="3" name="fonte_proc" showLabel="1" verticalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" underline="0"></labelFont>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="5" name="commento" showLabel="1" verticalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" underline="0"></labelFont>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorContainer collapsed="0" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="1" groupBox="1" horizontalStretch="0" name="Automatici" showLabel="1" type="GroupBox" verticalStretch="0" visibilityExpression="" visibilityExpressionEnabled="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" underline="0"></labelFont>
        </labelStyle>
  ...
  <editable>
    ...
    <field editable="1" name="proc_parz"></field>
    <field editable="1" name="proc_parz_ch"></field>
    <field editable="1" name="scala"></field>
    <field editable="1" name="scenari_prob_rottura"></field>
  </editable>
  <labelOnTop>
    ...
    <field labelOnTop="0" name="scenari_prob_rottura"></field>
  </labelOnTop>
  <reuseLastValue>
    ...
    <field name="liv_dettaglio" reuseLastValue="0"></field>
    <field name="matrice" reuseLastValue="0"></field>
    <field name="osservazioni" reuseLastValue="0"></field>
    <field name="periodo_ritorno" reuseLastValue="0"></field>
    <field name="prob_accadimento" reuseLastValue="0"></field>
    <field name="prob_propagazione" reuseLastValue="0"></field>
    <field name="prob_rottura" reuseLastValue="0"></field>
    <field name="proc_parz" reuseLastValue="0"></field>
    <field name="proc_parz_ch" reuseLastValue="0"></field>
    <field name="scala" reuseLastValue="0"></field>
  </reuseLastValue>
