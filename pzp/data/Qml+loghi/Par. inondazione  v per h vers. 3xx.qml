...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" minScale="1e+08" styleCategories="AllStyleCategories" simplifyDrawingTol="1" readOnly="0" simplifyLocal="1" version="3.4.6-Madeira" maxScale="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingHints="1">
  ...
  <renderer-v2 graduatedMethod="GraduatedColor" type="graduatedSymbol" enableorderby="0" symbollevels="1" attr="in_v_per_h_ls" forceraster="0">
    <ranges>
      <range symbol="0" upper="0.000000000000000" label="vxh&lt;= 0" render="true" lower="0.000000000000000"/>
      <range symbol="1" upper="0.500000000000000" label="0 &lt; vxh &lt;= 0.5" render="true" lower="0.000000000000000"/>
      <range symbol="2" upper="2.000000000000000" label="0.5 &lt; vxh &lt;= 2" render="true" lower="0.500000000000000"/>
      <range symbol="3" upper="9999.000000000000000" label="2 &lt; vxh" render="true" lower="2.000000000000000"/>
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1" force_rhr="0">
        <layer enabled="1" locked="0" pass="2" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="202,234,195,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="2" force_rhr="0">
        <layer enabled="1" locked="0" pass="3" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="123,200,124,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
  ...
  <aliases>
    ...
    <alias name="Limite inferiore" field="in_v_per_h_li" index="5"/>
    <alias name="Limite superiore" field="in_v_per_h_ls" index="6"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="in_v_per_h_li"/>
    <default expression="" applyOnUpdate="0" field="in_v_per_h_ls"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="in_v_per_h_li" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="in_v_per_h_ls" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="in_v_per_h_li" exp="" desc=""/>
    <constraint field="in_v_per_h_ls" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" name="in_v_per_h_li" hidden="0"/>
      <column width="-1" type="field" name="in_v_per_h_ls" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" name="Dati principali" columnCount="1" groupBox="0" visibilityExpression="">
      ...
      <attributeEditorField showLabel="1" name="in_v_per_h_li" index="5"/>
      <attributeEditorField showLabel="1" name="in_v_per_h_ls" index="6"/>
  ...
  <editable>
    ...
    <field name="in_v_per_h_li" editable="1"/>
    <field name="in_v_per_h_ls" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="in_v_per_h_li" labelOnTop="0"/>
    <field name="in_v_per_h_ls" labelOnTop="0"/>
